...
This document outlines security procedures and general policies for the `serialize-server-state`.
project.
...
The `serialize-server-state` maintainers and community take all security bugs in `serialize-server-state` seriously.
Thank you for improving the security of `serialize-server-state`. We appreciate your efforts and
